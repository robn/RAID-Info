...
sub _build_virtual_disks {
  ...
  state $state_map = {
    ...
    'clean, checking'              => sub { RAID::Info::VirtualDisk::State::Rebuilding->new(progress => shift) },
    'active, checking'             => sub { RAID::Info::VirtualDisk::State::Rebuilding->new(progress => shift) },
